			...
			<Box sx={{ width: "280px" }}>
				...
				<DialogContent sx={{ display: "flex", flexDirection: "column", pr: 0 }}>
					<Typography variant="body2">
						Selecting one of the tutors timeslots increases the chance of your meeting being scheduled quickly. It helps avoid conflicts and
						ensures you get the support you need at a convenient time.
					</Typography>
