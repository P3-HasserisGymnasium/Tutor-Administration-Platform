...
const TutorApplicationPage: React.FC<TutorApplicationPageProps> = ({ setPage }) => {
    ...
    const { handleSubmit, register, getValues, formState: { errors } } = formMethods;
        ...
        <Box sx={{ width: "100%", height: "100%", display: "flex", justifyContent: "center", alignItems: "center" }} >
            <Box sx={{ width: "50%", height: "100%", display: "flex", flexDirection: "column", justifyContent: "center", alignItems: "center", backgroundColor: theme.customColors.postBackGroundColor }} >
                <Box sx={{ gap: 5, width: "65%", display: "flex", flexDirection: "column", justifyContent: "center", alignItems: "center" }}>
                    ...
                    <TextField {...register("tutorProfileDescription")} sx={{ marginTop: 8, width: "100%" }} maxRows={25} id="tutorProfileDescription" label="Write your tutor description" variant="outlined" multiline />

                    <Box sx={{ width: "100%", display: "flex", flexDirection: "row", justifyContent: "flex-end", alignItems: "flex-end" }}>
                        <Button onClick={() => setPage("tutorTimeAvailability")} sx={{ margin: 1, backgroundColor: theme.customColors.headingTextColor }} variant="contained">Go back</Button>
                        <Button onClick={handleSubmit(registerTutor)} type="submit" sx={{ margin: 1 }} variant="contained" >Continue</Button>
                    </Box>
                </Box>
            </Box>
