...
export const CommunicationMedium = z.enum(["Discord", "Microsoft_teams", "Skype", "Messenger", "Email"] as const);
...
export type CommunicationMediumType = z.infer<typeof CommunicationMedium>;
